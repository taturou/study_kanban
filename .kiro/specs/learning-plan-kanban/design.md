...
+---------+-------------+-------------+---------------+-------------+-|Pomodoro Timer       |-+
|         | Backlog     |    Today    |  InProgress   |  OnHold     | |                     | |
|---------+-------------+-------------+---------------+-------------+-|                     |-|
|         |+-----------+|+-----------+|+-------------+|+-----------+|+|                     |+|
| English ||TCard      |||           |||             |||           ||||       Time          |||
|         |+-----------+|+-----------+||             ||+-----------+|+|                     |+|
...
| AppBar: [Menu Button] [Logo] [YYYY-MM-DD HH:MM] [Kanban | Dashboard] [sync status] [avatar] |
+---------------------------------------------------------------------------------------------+
| Kanban Header: Num of Today/Done tasks | Estimate/Done tasks               [Pomodoro Timer] |
+---------+-------------+-------------+---------------+-------------+------------+------------+
|         | Backlog     |    Today    |  InProgress   |  OnHold     |   Done     | Won't fix  |
|---------+-------------+-------------+---------------+-------------+------------+------------|
|         |+-----------+|+-----------+|+-------------+|+-----------+|+----------+|+----------+|
...
```
+---------------------------------------------------------------------------------------------+
|+--------------------------------+Y-MM-DD HH:MM] [Kanban | Dashboard] [sync status] [avatar] |
+| Settings Panel                 |-----------------------------------------------------------+
||                                |tasks | Estimate/Done tasks               [Pomodoro Start] |
+|                                |---+---------------+-------------+------------+------------+
||                                |   |  InProgress   |  OnHold     |   Done     | Won't fix  |
||                                |---+---------------+-------------+------------+------------|
||                                |--+|+-------------+|+-----------+|+----------+|+----------+|
||                                |  |||             |||           |||          |||          ||
||                                |--+||             ||+-----------+|+----------+|+----------+|
