...
```
+------------------------------------------------------------+
| AppBar: ロゴ | ナビゲーション | バージョン/同期ステータス     |
+------------------------------------------------------------+
| AlertBar: 非モーダル通知（同期/PT/更新）                  |
+------------------------------------------------------------+
| Kanban Header: 今日の予定/残り時間ゲージ                  |
+--------------------+---------------------------------------+
| SubjectColumn      | StatusGrid (スクロール)               |
| (固定表示)         | +-------------+-------------+-------+-|
| - 教科一覧         | | Backlog    | Today       | ...   | |
| - 教科追加ボタン   | | TaskCards  | TaskCards   |       | |
+--------------------+---------------------------------------+
| TaskDialog (Modal): タスク作成/編集フォーム               |
+------------------------------------------------------------+
```
...
| AppBar + Nav                                               |
+------------------------------------------------------------+
| SummaryCards: 週次サマリ・期日超過・バージョン表示         |
|------------------------------------------------------------|
| BurndownChart (週次残工数)                                 |
|------------------------------------------------------------|
| OverdueList / WeeklyStats                                  |
+------------------------------------------------------------+
```
...
| AppBar + Nav                                               |
+------------------------------------------------------------+
| CalendarHeader: 週/日切替・スプリント選択・予定表示        |
|------------------------------------------------------------|
| Month/Week Grid (月曜始まり)                               |
|------------------------------------------------------------|
| DayDetail: 実施/期日/追加タスク一覧＋学習可能時間編集      |
+------------------------------------------------------------+
```
...
+------------------------------------------------------------+
| Content (スクロール)                                       |
| [StatusLabelForm] 固定ステータスの表示名                   |
| [LanguageToggle] 言語切替                                  |
| [VersionSection] バージョン表示＋「更新を確認」            |
| [PomodoroDefaults] PT デフォルト時間                       |
| [BackupPanel] バックアップ/復元                            |
| [ReadonlyRefresh] 閲覧専用の更新間隔                       |
+------------------------------------------------------------+
```
...
| AlertBar (同期表示のみ)                                    |
+------------------------------------------------------------+
| Content: Kanban/Dashboard/Calendar の閲覧専用表示          |
+------------------------------------------------------------+
```
