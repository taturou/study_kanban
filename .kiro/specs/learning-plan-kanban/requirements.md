...
12. If Today、InPro、OnHold 各列の残り時間合計が当日の学習可能時間を超える, the LPK shall 非モーダルのアラートを表示し操作を継続可能とする。
...
14. When 学習者がPT を操作する, the LPK shall 作業/休憩時間の設定と開始・一時停止・リセットを可能にし、開始/終了/休憩開始を非モーダル通知する。
...
15. The LPK shall 主要操作（タスク作成・移動、ステータス遷移ルール、ダイアログ操作、カレンダー利用、時間設定）を説明するヘルプページ View を提供する。
